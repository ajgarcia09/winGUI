...
public class UserStats {
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			of the class profile, which pops up a 
			new window upon the user clicking on bnNewButton*/ 
			public void actionPerformed(ActionEvent e) {
				ProfileWindow userProfile = new ProfileWindow();
				userProfile.displayProfileWindow();
			}
		});
